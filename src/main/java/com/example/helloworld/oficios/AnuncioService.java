...
public interface AnuncioService {
     ...
     * a este método. Si no existe ningún anuncio con ese id, este método regresa un
     * producto nulo (null)
     * 
    ...
    /**
     * Elimina el anuncio cuyo id es el dado. Si no existe ningún anuncio con ese
     * di, no hace nada.
     * 
